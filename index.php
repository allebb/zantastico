...
$packages->Parse();
	...
	if(isset($_POST['btDeploy'])){
		// Validate no horrible characters before continuing
		if (!IsValidDomainName(str_replace("/", "", $_POST['inFolder']))){
		echo "<div class=\"zannouce\">Path error: The path you want cannot be created!</div><br><br>
		Please <a href=\"javascript:history.back(1)\">go back</a> and input a valid path!";
		} else {
